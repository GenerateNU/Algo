...
func (uc *UserController) CreateLongTermGoalForUser(c *gin.Context) {
    ...
    goal, err := uc.userService.CreateLongTermGoalForUser(uint(userID), input.LongTermGoal)
    if err != nil {
...
func (uc *UserController) UpdateLongTermGoalForUser(c *gin.Context) {
    ...
    updatedGoal, err := uc.userService.UpdateLongTermGoalForUser(uint(userID), uint(goalID), input.LongTermGoal)
    if err != nil {
